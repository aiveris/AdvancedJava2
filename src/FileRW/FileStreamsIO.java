...
public class FileStreamsIO {
    public static void main(String[] args) throws Exception {
        ...
        // FileOutputStream fos = new FileOutputStream("C:\\Users\\aiver\\Downloads\\FileStreams.txt");
        // String str="AAA This is going to be a really long line. We need to see" +
        ...
        FileInputStream fis=new FileInputStream("C:\\Users\\aiver\\Downloads\\FileStreams.txt");
        int i=0;
        while((i=fis.read()) != -1){
